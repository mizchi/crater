...
Snapshot of the MoonBit module graph across the workspace (26 modules).
...
graph LR
  ...
  mizchi_crater_testing --> mizchi_crater_webdriver_bidi
...
| --- | --- | --- | --- | --- |
| Foundation | `crater-css` | `css` | 10 | crater-layout |
| Foundation | `crater-dom` | `dom` | 11 | crater-css, crater-layout |
| Foundation | `crater-html-assets` | `html_assets` | 1 | — |
| Foundation | `crater-layout` | `layout` | 14 | — |
| Foundation | `crater-network` | `network` | 1 | — |
| Render | `crater-painter` | `painter` | 8 | crater-layout |
| Render | `crater-renderer` | `renderer` | 8 | crater-css, crater-dom, crater-layout, crater-painter, crater-renderer-inline-style-cache |
| Render | `crater-renderer-inline-style-cache` | `renderer_inline_style_cache` | 1 | crater-css, crater-layout |
| Render | `crater-renderer-terminal` | `renderer_terminal` | 1 | crater-css, crater-painter, crater-painter-terminal, crater-renderer |
| Render | `crater-webvitals` | `webvitals` | 1 | crater-layout |
...
| Test / Dev | `crater-benchmarks` | `benchmarks` | 0 | crater-browser, crater-css, crater-dom, crater-layout, crater-painter, crater-painter-terminal, crater-renderer |
| Test / Dev | `crater-testing` | `testing` | 0 | crater-browser, crater-browser-native, crater-browser-runtime, crater-css, crater-dom, crater-layout, crater-renderer, crater-webdriver-bidi |
