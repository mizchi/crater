...
Snapshot of the MoonBit module graph across the workspace (29 modules).
...
graph LR
  ...
  mizchi_crater_conformance --> mizchi_crater_css
...
| --- | --- | --- | --- | --- |
| Core | `crater-core` | `core` | 14 | — |
| Foundation | `crater-css` | `css` | 11 | crater-core |
| Foundation | `crater-dom` | `dom` | 11 | crater-core, crater-css, crater-layout |
| Foundation | `crater-html-assets` | `html_assets` | 1 | — |
| Foundation | `crater-layout` | `layout` | 13 | crater-core |
