...
Snapshot of the MoonBit module graph across the workspace (27 modules).
...
graph LR
  ...
  mizchi_crater_renderer --> mizchi_crater_painter_terminal
...
| Render | `crater-painter` | `painter` | 7 | crater-core, crater-layout |
| Render | `crater-renderer` | `renderer` | 7 | crater-core, crater-css, crater-dom, crater-layout, crater-painter, crater-painter-terminal |
