...
crater の DOM/AOM を活用した content extraction / grounding / structural diff
の補助 package 群。
...
これらの package は主に以下に依存:
- `mizchi/crater-dom/aom` - Accessibility Object Model
- `mizchi/crater-dom/html` - HTML Parser
- `mizchi/crater-dom/layout/html_tree` - HTML から layout/AOM 用ツリーを構築
- `mizchi/crater-layout` - bounds 計算に使う layout kernel
