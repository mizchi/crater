...
function printUsage() {
  console.error(
    "Usage: node benchmarks/scripts/component-vrt-bench-baseline.mjs [check|update|print] [--warmup N] [--runs N]",
  );
}
...
function main() {
  ...
  if (!baseline) {
    ...
    console.error("Run: node benchmarks/scripts/component-vrt-bench-baseline.mjs update");
    process.exit(1);
  }
