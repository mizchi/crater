...
test("browser http profile hides mutable implementation fields", () => {
  ...
  assert.match(mbti, /pub fn Profile::new\(jar_enabled\? : Bool\) -> Self/)
  assert.doesNotMatch(mbti, /user_agent/)
  assert.doesNotMatch(mbti, /Profile::effective_user_agent/)
  assert.doesNotMatch(mbti, /Profile::set_user_agent/)
  assert.doesNotMatch(mbti, /Profile::clear_user_agent/)
